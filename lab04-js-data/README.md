...
## Скріншоти
- [Каталог з фільтрами] (screenshots/catalog_main.png)
- [Пошук та сортування] (screenshots/catalog_search.png)
- [Модальне вікно деталей] (screenshots/catalog_details.png)
